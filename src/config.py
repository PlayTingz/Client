...
class ZeroGConfig:
    SERVICE_API_URL = os.getenv('ZG_SERVICE_API_URL')
    MODEL_NAME = os.getenv('ZG_MODEL_NAME')
    MODEL_ENDPOINT = os.getenv('ZG_MODEL_ENDPOINT')
    PROVIDER_ADDRESS = os.getenv('ZG_PROVIDER_ADDRESS')
